...
export function EditStudentForm({ student }: EditStudentFormProps) {
  ...
  const form = useForm<StudentFormValues>({
    ...
    defaultValues: {
      ...student,
      tanggalRegistrasi: parseDate(student.tanggalRegistrasi) || new Date(),
      tanggalLahir: parseDate(student.tanggalLahir),
      berkebutuhanKhusus: student.berkebutuhanKhusus || [],
      berkebutuhanKhususAyah: student.berkebutuhanKhususAyah || [],
      berkebutuhanKhususIbu: student.berkebutuhanKhususIbu || [],
    },
  });
  ...
  async function onSubmit(data: StudentFormValues) {
    ...
    try {
      ...
      await updateDoc(studentDocRef, processedData);
      toast({
        title: 'Sukses',
